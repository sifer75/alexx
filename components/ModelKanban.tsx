...
export const ModelKanban: React.FC<ModelKanbanProps> = (
  { kanbans, editKanban, deleteKanban, workspaceId },
        ...
        {kanbans.map((kanban) => (
          <Card className="w-[350px]" key={kanban.id}>
            ...
            <CardFooter className="flex justify-between">
              <Button>
                <Link href={`/workspaces/${workspaceId}/${kanban.id}`}>
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuItem>
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          Etes vous sur de vouloir effacer le kanban?
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>
                            <span>annuler</span>
                          ...
                          <AlertDialogAction>
                            <span
                              onClick={() =>
                                kanban.id && deleteKanban(kanban.id)
                              }
                            >
                              effacer
                            </span>
